...
// CONCATENATED MODULE: ./reducers/glory.js
const glory_initialState = 0; // 처음 state값으로 count 0을 주었다. state값은 객체, 배열로도 사용할 수 있다.
...
const reducer = (state = glory_initialState, action) => {
  // 리듀서
  switch (action.type) {
...
/* harmony default export */ var glory = (reducer);
// EXTERNAL MODULE: ./reducers/monster.js
var monster = __webpack_require__("ys3V");
var monster_default = /*#__PURE__*/__webpack_require__.n(monster);
...
const rootReducer = Object(external_redux_["combineReducers"])({
  ...
  monster: monster_default.a
});
/* harmony default export */ var reducers = (rootReducer); // _app.js에서 reducer로 사용된다!
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (external_next_redux_wrapper_default()(configureStore)(Test));
